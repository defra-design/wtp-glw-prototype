...
if ($('#ec-wastes-lab-typeahead-container').length > 0) {
  element = document.querySelector('#ec-wastes-lab-typeahead-container')
  id = 'ec-wastes-lab-typeahead' // To match it to the existing <label>.
