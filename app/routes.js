...
// Import Exporter V14 routes
router.use('/exporter-v14/', (req, res, next) => {
  //req.session.data["entered-criteria"] = undefined;
  return require(`./views/exporter-v14/_routes`)(req, res, next);
})

// Import Exporter V13 routes
router.use('/exporter-v13/', (req, res, next) => {
  //req.session.data["entered-criteria"] = undefined;
  return require(`./views/exporter-v13/_routes`)(req, res, next);
})

// Import Exporter V12 routes
router.use('/exporter-v12/', (req, res, next) => {
  //req.session.data["entered-criteria"] = undefined;
  return require(`./views/exporter-v12/_routes`)(req, res, next);
})

// Import Exporter V11 routes
router.use('/exporter-v11/', (req, res, next) => {
  //req.session.data["entered-criteria"] = undefined;
  return require(`./views/exporter-v11/_routes`)(req, res, next);
})

// Import Exporter V10 routes
router.use('/exporter-v10/', (req, res, next) => {
  //req.session.data["entered-criteria"] = undefined;
  return require(`./views/exporter-v10/_routes`)(req, res, next);
})

// Import Exporter V9 routes
router.use('/exporter-v9/', (req, res, next) => {
  //req.session.data["entered-criteria"] = undefined;
  return require(`./views/exporter-v9/_routes`)(req, res, next);
})
